...
i. Perform a hypothesis test on the coefficient for `Double` to test whether it is significantly different from 0. State your hypotheses, draw you conclusion, provide evidence for the conclusion, and interpret your conclusion in the context of the problem.
