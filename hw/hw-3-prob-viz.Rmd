...
Sign onto your RStudio cloud using this [link](https://rstudio.cloud/spaces/29360/project/606538). This link should take you directly to the homework project. MAKE A COPY OF THIS PROJECT only the first time you log on. If you do not make a copy it will keep warning you with a blinking note that it is a temporary project.
