...
Note that you have different knit options such as knitting to HTML or pdf. Even though HTML looks much nicer, we will use pdf because it is easier to upload to Gradescope.
